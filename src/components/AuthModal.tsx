            ...
            <div className="flex flex-col items-center justify-center py-6 text-center space-y-5">
              ...
              <div className="w-full max-w-sm space-y-3 pt-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-neutral-100 text-neutral-900 font-medium text-sm rounded-xl transition-all shadow-lg hover:shadow-xl disabled:opacity-50"
                >
